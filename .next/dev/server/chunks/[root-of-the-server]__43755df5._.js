...
"[project]/privlink/src/app/api/chats/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const chats = await __TURBOPACK__imported__module__$5b$project$5d2f$privlink$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].chat.findMany({
            include: {
                messages: {
                    take: 1,
                    orderBy: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$privlink$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(chats);
    } catch (error) {
...
async function POST(req) {
    try {
        ...
        const chat = await __TURBOPACK__imported__module__$5b$project$5d2f$privlink$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].chat.create({
            data: {
                name,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$privlink$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(chat);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__43755df5._.js.map