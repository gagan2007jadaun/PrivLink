...
"[project]/privlink/src/app/api/messages/[chatId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, props) {
    ...
    try {
        const { chatId } = params;
        const messages = await __TURBOPACK__imported__module__$5b$project$5d2f$privlink$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].message.findMany({
            where: {
                chatId,
                OR: [
                    {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$privlink$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(messages);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6e2035a5._.js.map