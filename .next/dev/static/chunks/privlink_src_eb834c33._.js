...
function Sidebar(t0) {
    ...
    if ($[0] !== "836e9eb01b8afb098bed1c0b1cc168c1490154b97e333decab3f4bcbef67d248") {
        for(let $i = 0; $i < 52; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "836e9eb01b8afb098bed1c0b1cc168c1490154b97e333decab3f4bcbef67d248";
    }
    ...
    if ($[46] !== t18 || $[47] !== t20 || $[48] !== t24 || $[49] !== t25 || $[50] !== t8) {
        t26 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$privlink$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
            className: "hidden w-80 flex-col border-r border-white/20 bg-white/40 backdrop-blur-xl dark:border-white/10 dark:bg-black/40 md:flex md:m-3 md:rounded-3xl md:border md:h-[calc(100vh-24px)] overflow-hidden shadow-[0_8px_32px_0_rgba(31,38,135,0.07)]",
            children: [
                t8,
                t18,
                t20,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$privlink$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/privlink/node_modules/next/dist/compiled/react/compiler-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$privlink$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/privlink/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$privlink$2f$node_modules$2f$socket$2e$io$2d$client$2f$build$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/privlink/node_modules/socket.io-client/build/esm/index.js [app-client] (ecmascript) <locals>");
var _s = __turbopack_context__.k.signature();
;
;
;
const useSocket = ()=>{
    ...
    if ($[0] !== "f9e1ca7f1b2d4ab80e58fd7fb382cc8843b8a3a4b0e3687d8b4f2cc13dd4eab2") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "f9e1ca7f1b2d4ab80e58fd7fb382cc8843b8a3a4b0e3687d8b4f2cc13dd4eab2";
    }
    ...
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = ()=>{
            const socketInstance = (0, __TURBOPACK__imported__module__$5b$project$5d2f$privlink$2f$node_modules$2f$socket$2e$io$2d$client$2f$build$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["io"])({
                path: "/api/socket/io",
...
function useAttention() {
    ...
    if ($[0] !== "983afd578d24a561caa6bf363d7075f5d5c22a6133a9f9bc1d9a044e01b30ed5") {
        for(let $i = 0; $i < 5; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "983afd578d24a561caa6bf363d7075f5d5c22a6133a9f9bc1d9a044e01b30ed5";
    }
...
function Home() {
                    ...
                    try {
                        ...
                        if (data_3 && data_3.length > 0) {
                            ...
                            const hydratedChats = data_3.map({
                                "Home.useEffect.fetchChats.hydratedChats": (chat)=>{
                        ...
                        console.error("API Error (Chats):", e_2);
                        setChats([]);
                        setActiveChatId("");
                    }
                }
        ...
        "Home.useEffect": ()=>{
            ...
            const fetchMessages = {
                "Home.useEffect.fetchMessages": async ()=>{
                    try {
                        const res_0 = await fetch(`/api/messages/${activeChatId}`);
                        if (!res_0.ok) throw new Error("Failed to load messages");
                        const data_4 = await res_0.json();
                        const currentUser = sessionStorage.getItem("alias");
                        const processed = data_4.map({
                            "Home.useEffect.fetchMessages.processed": (m_7)=>({
                                    ...m_7,
                                    // Map DB fields to UI fields if needed, or ensuring compatibility
                                    id: m_7.id,
                                    content: m_7.content,
                                    type: m_7.type || 'text',
                                    timestamp: m_7.createdAt ? new Date(m_7.createdAt).toLocaleTimeString([], {
                                        hour: '2-digit',
                                        minute: '2-digit'
                                    }) : m_7.timestamp,
                                    isMe: m_7.sender?.username === currentUser || m_7.senderId === currentUser,
                                    status: 'read' // db messages are historically read
                                })
                        }["Home.useEffect.fetchMessages.processed"]);
                        setMessages(processed);
                    } catch (e_4) {
                        console.error("API Error (Messages):", e_4);
                        setMessages([]);
                    }
                }
    ...
    const handleSetDisappearingDuration = async (duration_0)=>{
        if (!activeChatId) return;
        // Optimistic Update
        const updatedChat = {
            ...activeChat,
        ...
        try {
            ...
            console.error("Failed to update disappearing duration", e_5);
        ...
        const saveMessage = async ()=>{
            ...
            if (type !== 'text' && (content.startsWith('data:') || content.startsWith('blob:'))) {
                try {
                    ...
                    const res_1 = await fetch(content);
                    const blob = await res_1.blob();
                    ...
                    console.error("Cloudinary upload failed", e_6);
                }
            }
            fetch('/api/messages', {
                method: 'POST',
        ...
        if (!isOnline) {
            ...
            if (!isIncognito) {
                try {
                    ...
                    console.error("Failed to save queue:", e_7);
                }
            }
    ...
    const handleCreateChat = (data_5)=>{
        ...
        setActiveChatId(newChat_0.id);
        // Initialize empty messages for the new chat
        __TURBOPACK__imported__module__$5b$project$5d2f$privlink$2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockMessages"][newChat_0.id] = [
            {
                id: 'welcome',
                type: 'text',
        ...
        setMessages(__TURBOPACK__imported__module__$5b$project$5d2f$privlink$2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockMessages"][newChat_0.id]);
    };
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$privlink$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            !activeChat ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$privlink$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex flex-1 items-center justify-center bg-zinc-50 dark:bg-black text-zinc-400",
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$privlink$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$privlink$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "absolute inset-0 bg-white/55 dark:bg-black/20 mix-blend-overlay"
                            }, void 0, false, {
                                fileName: "[project]/privlink/src/app/chat/page.tsx",
                                lineNumber: 1096,
                                columnNumber: 13
...
//# sourceMappingURL=privlink_src_eb834c33._.js.map