...
function AppNavigation() {
    ...
    if ($[0] !== "d93b10640440c583561693f32371a6e433cf403b7d14fde09bf396c05fa53b05") {
        for(let $i = 0; $i < 23; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "d93b10640440c583561693f32371a6e433cf403b7d14fde09bf396c05fa53b05";
    }
...
function useAttention() {
    ...
    if ($[0] !== "90434698dee3599b6ff75f6f34b7e0c64d98bceb369beef8705c86507a7df7d8") {
        for(let $i = 0; $i < 5; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "90434698dee3599b6ff75f6f34b7e0c64d98bceb369beef8705c86507a7df7d8";
    }
