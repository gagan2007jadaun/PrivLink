...
export default function Sidebar({ onNavigate }: SidebarProps) {
    return (
        <aside className="h-full w-full flex-col bg-transparent md:flex">
            {/* Header */}
            ...
            <div className="flex gap-2 border-t border-zinc-200 p-4 dark:border-zinc-800">
                <button
                    ...
                    className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-zinc-200 bg-white text-zinc-500 shadow-sm transition-all hover:bg-zinc-50 hover:text-zinc-600 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-400 dark:hover:bg-zinc-700"
                >
