...
export default function Sidebar({ chats, activeChatId, onSelectChat, onCreateChat, onArchiveChat, onDeleteChat }: SidebarProps) {
    ...
    return (
        <aside className="hidden flex-1 flex-col border-r border-zinc-200 bg-white/50 backdrop-blur-xl dark:border-zinc-800 dark:bg-zinc-900/50 md:flex h-full overflow-hidden">
            {/* Header */}
